...
pub const CDN_VERSIONS: CdnVersions = CdnVersions {
    ...
    mermaid: "11.6.0",         // renovate: datasource=npm depName=mermaid
    nord_highlightjs: "0.1.0", // renovate: datasource=npm depName=nord-highlightjs
    fusejs: "7.0.0",           // renovate: datasource=npm depName=fuse.js
};
